...
- Three contexts: **Work / Side Gig / Social** — every reminder belongs to exactly one. Contexts drive default channel, color, quiet hours.
...
- Mobile-first UI; dark mode required; context colors: Work=blue, Side Gig=amber, Social=green
